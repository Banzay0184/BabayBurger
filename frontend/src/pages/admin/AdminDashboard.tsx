...
export const AdminDashboard: React.FC = () => {
  ...
  const StatCard: React.FC<{
    ...
    const content = (
      <div className={`p-6 bg-white rounded-2xl border-l-4 ${color} shadow-lg hover:shadow-xl transition-all duration-200 hover:-translate-y-1 group`}>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center pb-6">
        ...
        <p className="text-gray-600 text-lg">Обзор системы и ключевые метрики</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200/50 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-2">
              <span className="text-lg mr-2">⏳</span>
              <div className="text-yellow-800 font-semibold text-sm">Ожидают</div>
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200 rounded-xl p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-2">
              <span className="text-lg mr-2">👨‍🍳</span>
              <div className="text-blue-800 font-semibold text-sm">Готовятся</div>
            </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-2">
              <span className="text-lg mr-2">✅</span>
              <div className="text-green-800 font-semibold text-sm">Завершены</div>
            </div>
          ...
          <div className="bg-gradient-to-br from-red-50 to-pink-50 border border-red-200 rounded-xl p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center mb-2">
              <span className="text-lg mr-2">❌</span>
              <div className="text-red-800 font-semibold text-sm">Отменены</div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden">
          <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-yellow-50 to-orange-50">
            <h3 className="text-xl font-bold text-gray-900 flex items-center">
              <span className="w-8 h-8 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-lg flex items-center justify-center text-white text-sm mr-3">🏆</span>
              Популярные товары
            </h3>
          </div>
          <div className="p-6">
              ...
              <div className="space-y-4">
                {topItems.slice(0, 5).map((item, index) => (
                  <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                    <div className="flex items-center">
                      <div className="w-8 h-8 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg flex items-center justify-center text-white text-sm font-bold mr-3">
                        {index + 1}
                      </div>
            ...
            {dailyStats.length > 0 ? (
              <div className="space-y-4">
                {dailyStats.slice(-7).map((day) => (
                  <div key={day.date} className="flex items-center justify-between p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                    ...
                    <div className="flex items-center space-x-4">
                      <span className="text-sm text-gray-600 bg-blue-100 px-2 py-1 rounded-full">{day.orders} заказов</span>
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden">
        <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-green-50 to-emerald-50">
          <h3 className="text-xl font-bold text-gray-900 flex items-center">
            <span className="w-8 h-8 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center text-white text-sm mr-3">⚡</span>
            Быстрые действия
          </h3>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link 
              to="/admin/menu" 
              className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl hover:from-blue-100 hover:to-blue-200 transition-all duration-200 hover:shadow-md group"
            >
              <div className="text-center">
                <div className="text-3xl mb-3 group-hover:scale-110 transition-transform">🍽️</div>
                <div className="text-blue-800 font-bold text-sm">Управление меню</div>
                <div className="text-xs text-blue-600 mt-1">Добавить товар</div>
              </div>
            </Link>
            <Link 
              to="/admin/promocodes" 
              className="p-6 bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl hover:from-green-100 hover:to-green-200 transition-all duration-200 hover:shadow-md group"
            >
              <div className="text-center">
                <div className="text-3xl mb-3 group-hover:scale-110 transition-transform">🎫</div>
                <div className="text-green-800 font-bold text-sm">Создать промокод</div>
                <div className="text-xs text-green-600 mt-1">Новая акция</div>
              </div>
            </Link>
            <Link 
              to="/admin/orders" 
              className="p-6 bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl hover:from-purple-100 hover:to-purple-200 transition-all duration-200 hover:shadow-md group"
            >
              <div className="text-center">
                <div className="text-3xl mb-3 group-hover:scale-110 transition-transform">📋</div>
                <div className="text-purple-800 font-bold text-sm">Заказы</div>
                <div className="text-xs text-purple-600 mt-1">Просмотр заказов</div>
              </div>
            </Link>
            <Link 
              to="/admin/analytics" 
              className="p-6 bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-xl hover:from-orange-100 hover:to-orange-200 transition-all duration-200 hover:shadow-md group"
            >
              <div className="text-center">
                <div className="text-3xl mb-3 group-hover:scale-110 transition-transform">📈</div>
                <div className="text-orange-800 font-bold text-sm">Аналитика</div>
