...
export const AuthPage: React.FC = () => {
  ...
  if (state.isLoading) {
    return (
      <div className="tg-webapp flex items-center justify-center tg-safe-top tg-safe-bottom bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="text-center animate-slide-up">
          <div className="mb-8">
            <div className="relative mb-8">
              <div className="w-24 h-24 bg-gradient-to-br from-primary-500 to-primary-600 rounded-3xl flex items-center justify-center mx-auto shadow-glow animate-pulse-glow">
        ...
        <div className="mt-12 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className="p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/30">
              ...
              <p className="text-xs font-medium text-gray-700">Быстрая доставка</p>
            </div>
            <div className="p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/30">
              <span className="text-2xl mb-2 block">🍔</span>
              <p className="text-xs font-medium text-gray-700">Вкусные бургеры</p>
            </div>
            <div className="p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-white/30">
              <span className="text-2xl mb-2 block">💳</span>
              <p className="text-xs font-medium text-gray-700">Удобная оплата</p>
            </div>
          </div>
        </div>
      </div>
